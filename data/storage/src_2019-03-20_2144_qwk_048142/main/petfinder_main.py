...
from src.features.build_features import fill_and_drop_feature, fill_and_drop_feature2
...
def main():
    ...
    labels_state = pd.read_csv(os.path.join(input.__path__[0], 'petfinder-adoption-prediction/my_state_labels.csv'))
    ...
    X_train_non_null = fill_and_drop_feature2(X_train_non_null)
    X_test_non_null = fill_and_drop_feature2(X_test_non_null)
