...
def fill_and_drop_feature_end(data):
    data.drop(['main_state_West_East', 'main_state_States_Federal', 'main_breed_Type',
               'main_state_State', 'second_breed_Type', 'VideoAmt', 'metadata_crop_conf_MEAN', 'metadata_crop_conf_SUM',
               'metadata_crop_importance_SUM', 'metadata_crop_conf_VAR'], axis=1, inplace=True)
